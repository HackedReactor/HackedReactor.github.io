...
#Import the data
beers = read.csv("/Users/password1234/Documents/Doing_Data_Science/MSDS_6306_Doing-Data-Science/Unit\ 8\ and\ 9\ Case\ Study\ 1/Beers.csv", header = TRUE)
breweries = read.csv("/Users/password1234/Documents/Doing_Data_Science/MSDS_6306_Doing-Data-Science/Unit\ 8\ and\ 9\ Case\ Study\ 1/Breweries.csv", header = TRUE)
```
...
Beers_Breweries <- Beers_Breweries %>% mutate(StyleCategory = 
  case_when(str_detect(Beers_Breweries$Style, "IPA") ~ "IPA",
  str_detect(Beers_Breweries$Style, "Wheat Ale") ~ "Wheat Ale",
  str_detect(Beers_Breweries$Style, "APA") ~ "APA",
  str_detect(Beers_Breweries$Style, "Strong Ale") ~ "Strong Ale",
  str_detect(Beers_Breweries$Style, "Dark Ale") ~ "Dark Ale",
  str_detect(Beers_Breweries$Style, "Mild Ale") ~ "Mild Ale",
  str_detect(Beers_Breweries$Style, "Old Ale") ~ "Old Ale",
  str_detect(Beers_Breweries$Style, "Farmhouse Ale") ~ "Ale",
  str_detect(Beers_Breweries$Style, "Ale") ~ "Ales(Other)",
  str_detect(Beers_Breweries$Style, "Lager") ~ "Lager",
  str_detect(Beers_Breweries$Style, "Barleywine") ~ "Barleywine",
  str_detect(Beers_Breweries$Style, "Liquor") ~ "Liquor",
  str_detect(Beers_Breweries$Style, "Pilsner") ~ "Pilsner",
  str_detect(Beers_Breweries$Style, "Porter") ~ "Porter",
  str_detect(Beers_Breweries$Style, "Stout") ~ "Stout",
  str_detect(Beers_Breweries$Style, "Beer") ~ "Beer",
  str_detect(Beers_Breweries$Style, "Cider") ~ "Cider",
  str_detect(Beers_Breweries$Style, "Lager") ~ "Lager",
  str_detect(Beers_Breweries$Style, "Bitter") ~ "Bitter",
  TRUE ~ "Other/Unknown"))
